...
{
    class MicrosoftExample
    {

        // Path variables for source, encryption, and
        // decryption folders. Must end with a backslash.
        private static string encrFolder = @"C:\Users\const\source\repos\Uncertain\Certificate\TestCertificate\Test\Encrypt\";
        private static string decrFolder = @"C:\Users\const\source\repos\Uncertain\Certificate\TestCertificate\Test\Decrypt\";
        ...
        public static void Main() {
            ...
            X509Certificate2 cert = GetCertificateFromStore("CN=Patti Fuller");
            if (cert == null) {
                Console.WriteLine("Certificate 'CN=Patti Fuller' not found.");
                Console.ReadLine();
            }
